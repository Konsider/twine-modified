...
export interface Passage {
	/**
	 * Is this passage a confirmed ending?
	 * Endings must have no outgoing links.
	 */
	end: boolean;
	/**
	...
	height: number;
	/**
	 * Reference image filename for this passage (editor-only, not exported).
	 * This is just the filename (e.g. "abc123.png"), not a full path.
	 */
	image?: string;
	/**
...
export interface Story {
	...
	zoom: number;
	/**
	 * Saved horizontal scroll position of the story map editor.
	 */
	mapScrollLeft: number;
	/**
	 * Saved vertical scroll position of the story map editor.
	 */
	mapScrollTop: number;
}
...
export type SearchScope = 'text' | 'names' | 'both';
