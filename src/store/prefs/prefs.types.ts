...
export interface PrefsState {
	...
	/**
	 * Default directory for saving/exporting files (Electron only).
	 */
	...
	/**
	 * Use spell checking in the passage editor? When enabled, the passage
	 * editor uses a plain textarea so the browser can show red underlines.
	 */
	spellCheckInPassageEditor: boolean;
	/**
	 * Has the user been shown the welcome route?
	 */
	welcomeSeen: boolean;
	/**
	 * Tracks which custom-version migrations have been applied.
	 */
	customMigrationVersion: number;
}
