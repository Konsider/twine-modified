...
export const MarqueeSelection: React.FC<MarqueeSelectionProps> = props => {
	...
	React.useEffect(() => {
		...
		function downListener(event: PointerEvent) {
			...
			// Prevent the browser from starting native text selection or
			// drag-and-drop, which conflicts with the marquee and causes
			// a "no entry" cursor with all passages highlighted.
